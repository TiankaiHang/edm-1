```.bash
torchrun  --standalone --nproc_per_node=8 train.py --outdir /mnt/external/exp/iccv2023_rebuttal/ --data /mnt/external/datasets/edm/imagenet-64x64.zip --cond=1 --arch=adm --duration=2500 --batch=4096 --lr=1e-4 --ema=50 --dropout=0.10 --augment=0 --fp16=1 --ls=100 --tick=200
```
...
torchrun  --standalone --nproc_per_node=8 train.py --outdir /mnt/external/exp/iccv2023_rebuttal/ --data /mnt/external/datasets/edm/imagenet-64x64.zip --cond=1 --arch=adm --duration=2500 --batch=128 --lr=1e-4 --ema=50 --dropout=0.10 --augment=0 --fp16=1 --ls=100 --tick=200 --loss-type min-snr-5
